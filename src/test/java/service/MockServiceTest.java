...
public class MockServiceTest {
    ...
    @Test
    public void returnChampionNameVayneTest(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void returnChampionPositionMidTest(){
        Champion champion = mock(Champion.class);
    ...
    public void shouldDoThrowExceptionWhenChampionNameYasuoTest(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void verifySetPositionMidTest(){
        Champion champion = mock(Champion.class);
    ...
    @Test
    public void shouldOnetimeRunForChampionArraySizeTest(){
        List<Champion> mockChampions = mock(List.class);
        when(mockChampions.size()).thenReturn(5);
    ...
    @Test
    public void runGetNameAtLeastTwice(){
        Champion champion = mock(Champion.class);
        when(champion.getName()).thenReturn("소라카");
    ...
    @Test
    public void runGetNameAtMostThree(){
        Champion champion = mock(Champion.class);
        when(champion.getName()).thenReturn("소라카");
    ...
    @Test
    public void findByNameLissandraTest(){
    ...
    @Test
    public void fakeChampionReturnTest(){
        when(mockService.findByName(anyString())).thenReturn(new Champion("티모","탑",1));

        assertThat(mockService.findByName("징크스").getHasSkinCount(),is(1));
        verify(mockRepository,times(1)).findByName("징크스");
    }
